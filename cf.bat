...
if !Max! GEQ !Speed! (cls &&echo !a! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !a! 不满足带宽需求 && goto two)
:two
chcp 936
del CRLF.txt cut.txt speed.txt
cls
...
if !Max! GEQ !Speed! (cls &&echo !a! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !a! 不满足带宽需求 && goto three)
:three
chcp 936
del CRLF.txt cut.txt speed.txt
cls
...
if !Max! GEQ !Speed! (cls &&echo !b! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !b! 不满足带宽需求 && goto four)
:four
chcp 936
del CRLF.txt cut.txt speed.txt
cls
...
if !Max! GEQ !Speed! (cls &&echo !b! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !b! 不满足带宽需求 && goto five)
:five
chcp 936
del CRLF.txt cut.txt speed.txt
cls
...
if !Max! GEQ !Speed! (cls &&echo !c! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !c! 不满足带宽需求 && goto six)
:six
chcp 936
del CRLF.txt cut.txt speed.txt
cls
...
if !Max! GEQ !Speed! (cls &&echo !c! 满足 %Bandwidth% Mbps带宽需求 && echo 峰值速度 !Max! kB/s && goto end) else (cls &&echo !c! 不满足带宽需求 && goto start)
:end
set /a stopH=%time:~0,2%
set /a stopM=%time:~3,2%
set /a stopS=%time:~6,2%
